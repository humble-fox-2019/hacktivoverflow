<template>
  <div class="main-card mt-4 rounded p-2">
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-end align-items center" style="width: 39%">
        <button class="btn log-btn mr-2" @click.prevent="deleteQuestion(question._id)">
          <i class="fas fa-trash-alt"></i> Delete
        </button>
        <button class="btn log-btn mr-2" @click.prevent="editQuestion(question._id)">
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          axios({
            ...
            .then(({ data }) => {
              Swal.fire(`Success`, `Question has been delete`, `success`);
              this.$store.dispatch("fetchFeed");
              this.$store.dispatch("fetchQuestion");
            })
            .catch(err => {
