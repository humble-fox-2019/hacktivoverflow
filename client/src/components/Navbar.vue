<template>
  <div>
    <b-navbar toggleable="lg" type="light" variant="light">
      <b-container>
        <b-navbar-brand style="color: #FB9A3F; cursor: pointer" @click="goToHome"> <span style="font-size: 1.5rem">Too</span><span style="font-size: 1.5rem; font-weight: bold">Overflow</span></b-navbar-brand>
        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-item href="" @click.prevent="goToAddQuestion">+ Question</b-nav-item>
