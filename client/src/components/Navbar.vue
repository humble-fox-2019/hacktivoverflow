    ...
    <div class="container py-3">
      <div class="row">
        <div class="col-md-12 d-flex justify-content-between">
          ...
          <button v-if="token === null" v-b-modal.modal-login class="btn btn-primary px-4">Login</button>
          <button @click="logout" v-else class="btn btn-primary px-4">Logout</button>
        </div>
      </div>
    </div>
    <b-modal
