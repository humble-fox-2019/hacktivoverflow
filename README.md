...
|     ROUTE      | HTTP | HEADERS | BODY |    DESCRIPTION     | ADDITIONAL INFO |
| :------------: | :--: | :-----: | :--: | :----------------: | :-------------: |
| /questions | GET  |    -    |  -   | Find All Questions |        -        |
...
[
    {
        ...
        "title": "baruuu",
        "description": "baruuu",
        "userId": "5d8c8908abba132be67d98cb",
...
|        ROUTE        | HTTP | HEADERS | BODY |  DESCRIPTION   | ADDITIONAL INFO |
| :-----------------: | :--: | :-----: | :--: | :------------: | :-------------: |
| /questions/find/:id | GET  |    token    |  -   | Get a question |        -        |
...
```
{
    ...
    "userId": "5d8ae0086527df0918be7130",
    "__v": 0
}
```
...
|   ROUTE    | HTTP | HEADERS |                           BODY                           |     DESCRIPTION     | ADDITIONAL INFO |
| :--------: | :--: | :-----: | :------------------------------------------------------: | :-----------------: | :-------------: |
| /questions | POST |  -  | title:String(required)<br />description:String(required) | Register a question |  authenticated  |
...
|   ROUTE    | HTTP | HEADERS | BODY |     DESCRIPTION     | ADDITIONAL INFO |
| :--------: | :--: | :-----: | :--: | :-----------------: | :-------------: |
| /questions/:userId | GET  |  token  |  -   | Get user's question |  authenticated  |
...
|         ROUTE         | HTTP  | HEADERS | BODY |    DESCRIPTION    | ADDITIONAL INFO |
| :-------------------: | :---: | :-----: | :--: | :---------------: | :-------------: |
| /questions/:id/upvote | PATCH |  token  |  -   | upvote a question |  authenticate   |
...
|          ROUTE          | HTTP  | HEADERS | BODY |     DESCRIPTION     | ADDITIONAL INFO |
| :---------------------: | :---: | :-----: | :--: | :-----------------: | :-------------: |
| /questions/:id/donwvote | PATCH |  token  |  -   | downvote a question |  authenticate   |
...
[
    {
        ...
        "description": "testtt",
        "userId": "5d8c5a836a92bf3f4a466da2",
...
|        ROUTE        | HTTP  | HEADERS | BODY |   DESCRIPTION    | ADDITIONAL INFO |
| :-----------------: | :---: | :-----: | :--: | :--------------: | :-------------: |
| /answers/:id/upvote | PATCH |  token  |  -   | upvote an answer |  authenticate   |
...
|         ROUTE         | HTTP  | HEADERS | BODY |    DESCRIPTION     | ADDITIONAL INFO |
| :-------------------: | :---: | :-----: | :--: | :----------------: | :-------------: |
| /answers/:id/downvote | PATCH |  token  |  -   | downvote an answer |  authenticate   |
